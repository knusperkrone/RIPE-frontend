...
typedef FetchCallback = void Function(bool isFetching);

class SensorHistoryService {
  static const _CACHE_LIFETIME = Duration(minutes: 10);
  static Tuple2<DateTime, List<SensorDataDao>>? _cache;
  ...
  SensorHistoryService(this.sensor);
  ...
  Future<List<SensorDataDao>> getHistoryData(
    ...
    callback(daysToFetch.isNotEmpty || !_isCacheHealthy());
